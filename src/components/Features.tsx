      ...
      <div className="section-container">
        <div className="text-center mb-10 sm:mb-16">
          ...
          <p className="section-subtitle mx-auto opacity-0 fade-in-element">
            Dive into cutting-edge technologies and build the future with us.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          <FeatureCard
            ...
            title="AI/ML"
            description="Explore machine learning algorithms, neural networks, and artificial intelligence to build intelligent systems."
            index={0}
          />
          <FeatureCard
            ...
            title="Data Science"
            description="Dive into data analysis, visualization, and statistical modeling to extract insights from complex datasets."
            index={1}
          />
          <FeatureCard
            icon={<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5 sm:w-6 sm:h-6"><path d="M22 17H2a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2Z"></path><path d="M22 17V9"></path><path d="M2 17V9"></path><path d="m2 5 20-2v6"></path><circle cx="12" cy="13" r="2"></circle></svg>}
            title="Cloud Computing"
            description="Master cloud platforms like AWS, Azure, and GCP to build scalable and distributed applications."
            index={2}
          />
          <FeatureCard
            icon={<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5 sm:w-6 sm:h-6"><path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z"></path><polyline points="14 2 14 8 20 8"></polyline><path d="M9 13v-1h6v1"></path><path d="M12 18h.01"></path></svg>}
            title="Frontend Development"
            description="Create beautiful, responsive user interfaces with HTML, CSS, JavaScript, React, and modern frameworks."
            index={3}
          />
          <FeatureCard
          ...
          <FeatureCard
            ...
            title="Open Source"
            description="Contribute to open source projects, collaborate with developers worldwide, and give back to the community."
            index={5}
          />
        </div>
      </div>
